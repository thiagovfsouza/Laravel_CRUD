...
<body>
    ...
    <div class="wrapper">
        <label class="title mb-4">{{ trans('messages.Register') }}</label>
        <div id="formContent">
            <form>
                <input type="text" id="name" class="mt-4" name="name" placeholder="{{ trans('messages.Name') }}" required>
                <input type="text" id="email" class="mt-4" name="email" placeholder="{{ trans('messages.Email') }}" required>
                <input type="text" id="password" class="password mt-4" name="password" placeholder="{{ trans('messages.Password') }}" required>
                <input type="text" id="password_confirmation" class="password mt-4" name="password_confirmation" placeholder="{{ trans('messages.Confirm Password') }}" required>
                <input type="submit" id="submit" class="mt-4" value="{{ trans('messages.Register') }}">
            </form>
            <div id="formFooter">
                <a class="underlineHover" href="{{ route('login') }}">{{ trans('messages.Login') }}</a>
            </div>
        </div>
    </div>
